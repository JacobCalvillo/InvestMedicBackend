...
const uploadFileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const image = yield (0, file_service_1.uploadImage)(files, folder, Number(userId));
...
const uploadFilesController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userId = req.params.id;
        const object = Array.isArray(files) ? files.map((file) => __awaiter(void 0, void 0, void 0, function* () { return yield (0, file_service_1.uploadImage)(file, folder, Number(userId)); })) : [yield (0, file_service_1.uploadImage)(files, folder, Number(userId))];
        console.log(object);
...
const getFilesController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const folder = req.query.folder || 'default-folder';
        const images = yield (0, file_service_1.getImages)(folder);
...
const getSignedUrlController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const url = yield (0, file_service_1.getSignedUrl)(file, expires);
...
const getFileUrlController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const userId = req.params.id;
        const image = yield (0, file_service_1.getFileUrl)(folder, userId, name);
        if (!image) {
...
const getFileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let name = (_b = req.query.name) === null || _b === void 0 ? void 0 : _b.toString();
        const userId = req.params.id;
        const image = yield (0, file_service_1.getImage)(folder, userId, name);
        if (!image) {
            res.status(404).send({ message: 'File not found' });
            return;
        }
...
const downloadFileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        name = name + '.jpg';
        yield (0, file_service_1.downloadImage)(folder, userId, name);
